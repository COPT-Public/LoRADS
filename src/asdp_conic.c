...
extern asdp_retcode AConePresolveData( asdp_cone *ACone, int Dim) {
    ...
    ASDP_INIT(dataMat->dsMatElem, double, Dim * Dim);
    ASDP_ZERO(dataMat->dsMatElem, double, Dim * Dim);
    ...
    ASDP_INIT(dataMatObj->dsMatElem, double, Dim * Dim);
    ASDP_ZERO(dataMatObj->dsMatElem, double, Dim * Dim);
    ...
    ASDP_INIT(slackVarSdp_coeff->dsMatElem, double, Dim * Dim);
    ASDP_ZERO(slackVarSdp_coeff->dsMatElem, double, Dim * Dim);
